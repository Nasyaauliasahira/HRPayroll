@extends('layouts.app')
@section('breadcrumb', 'Add Attendance')
@section('content')
<div class="max-w-xl mx-auto">
    <h1 class="text-[20px] font-semibold text-gray-900 mb-6">Add Attendance</h1>
    <form method="POST" action="{{ route('attendance.store') }}" class="bg-white border border-[#E8E6E1] rounded-xl p-6 form-grid grid grid-cols-2 gap-4">
        @csrf
        ...
        <div class="flex flex-col gap-1.5">
            ...
            <input type="date" name="date" value="{{ old('date') }}" class="h-[38px] px-3 border border-[#E8E6E1] rounded-lg text-sm bg-white @error('date') border-[#E8433A] bg-[#FEF0EE] @enderror" />
        ...
        <div class="flex flex-col gap-1.5">
            ...
            <select name="status" class="h-[38px] px-3 border border-[#E8E6E1] rounded-lg text-sm bg-white @error('status') border-[#E8433A] bg-[#FEF0EE] @enderror">
                ...
                <option value="present" @selected(old('status') == 'present')>On Time</option>
        ...
        <div class="flex flex-col gap-1.5">
            ...
            <input type="datetime-local" name="check_in" value="{{ old('check_in') }}" class="h-[38px] px-3 border border-[#E8E6E1] rounded-lg text-sm bg-white @error('check_in') border-[#E8433A] bg-[#FEF0EE] @enderror" />
        ...
        <div class="flex flex-col gap-1.5">
            ...
            <input type="datetime-local" name="check_out" value="{{ old('check_out') }}" class="h-[38px] px-3 border border-[#E8E6E1] rounded-lg text-sm bg-white @error('check_out') border-[#E8433A] bg-[#FEF0EE] @enderror" />
        ...
        <div class="flex flex-col gap-1.5 col-span-2">
            ...
            <input type="text" name="notes" value="{{ old('notes') }}" class="h-[38px] px-3 border border-[#E8E6E1] rounded-lg text-sm bg-white @error('notes') border-[#E8433A] bg-[#FEF0EE] @enderror" placeholder="Notes (optional)" />
