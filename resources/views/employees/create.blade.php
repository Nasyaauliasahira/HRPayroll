...
<div class="max-w-2xl mx-auto">
    <h1 class="text-[20px] font-semibold text-gray-900 mb-6">Add Employee</h1>
    <form method="POST" action="{{ route('employees.store') }}" enctype="multipart/form-data" class="bg-white border border-[#E8E6E1] rounded-xl p-6 form-grid grid grid-cols-2 gap-4">
        @csrf
        <div class="flex flex-col gap-1.5">
            <label class="text-[11px] font-medium text-[#666] uppercase tracking-[0.5px]">Name</label>
            <input type="text" name="name" value="{{ old('name') }}" class="h-[38px] px-3 border border-[#E8E6E1] rounded-lg text-sm bg-white @error('name') border-[#E8433A] bg-[#FEF0EE] @enderror" placeholder="Full name" />
        ...
        <div class="flex flex-col gap-1.5">
            ...
            <input type="email" name="email" value="{{ old('email') }}" class="h-[38px] px-3 border border-[#E8E6E1] rounded-lg text-sm bg-white @error('email') border-[#E8433A] bg-[#FEF0EE] @enderror" placeholder="Email address" />
        ...
        <div class="flex flex-col gap-1.5">
            ...
            <input type="text" name="phone" value="{{ old('phone') }}" class="h-[38px] px-3 border border-[#E8E6E1] rounded-lg text-sm bg-white @error('phone') border-[#E8433A] bg-[#FEF0EE] @enderror" placeholder="Phone number" />
        ...
        <div class="flex flex-col gap-1.5">
            ...
            <input type="text" name="nik" value="{{ old('nik') }}" class="h-[38px] px-3 border border-[#E8E6E1] rounded-lg text-sm bg-white @error('nik') border-[#E8433A] bg-[#FEF0EE] @enderror" placeholder="NIK" />
        ...
        <div class="flex flex-col gap-1.5">
            ...
            <input type="number" name="base_salary" value="{{ old('base_salary') }}" class="h-[38px] px-3 border border-[#E8E6E1] rounded-lg text-sm bg-white numeric @error('base_salary') border-[#E8433A] bg-[#FEF0EE] @enderror" placeholder="Base salary" />
        ...
        <div class="flex flex-col gap-1.5">
            ...
            <input type="date" name="join_date" value="{{ old('join_date') }}" class="h-[38px] px-3 border border-[#E8E6E1] rounded-lg text-sm bg-white @error('join_date') border-[#E8433A] bg-[#FEF0EE] @enderror" />
        ...
        <div class="col-span-2 flex justify-end gap-2 mt-4">
            ...
            <button class="bg-[#1a1a1a] text-white px-4 py-2 rounded-lg text-sm font-medium">Save</button>
        </div>
    </form>
</div>
@endsection
